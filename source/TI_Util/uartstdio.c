...
{
     SCIA_BASE, SCIB_BASE, SCIC_BASE, SCID_BASE
};
#endif
...
//
#if 0
static const uint32_t g_ui32UARTPeriph[4] =
{
     SYSCTL_PERIPH_CLK_SCIA, SYSCTL_PERIPH_CLK_SCIB, SYSCTL_PERIPH_CLK_SCIC, SYSCTL_PERIPH_CLK_SCID
};
#endif
...
void
UARTsysprintf(const char *pcString, ...)
{
    va_list vaArgP;
